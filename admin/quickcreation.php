...
if ($action == 'set_config') {
	...
	if (!empty($projectOpportunityStatus)) {
		dolibarr_set_const($db, 'DOLICAR_PROJECT_OPPORTUNITY_STATUS_VALUE', $projectOpportunityStatus, 'integer', 0, '', $conf->entity);
	}
	if ($projectOpportunityAmount >= 0) {
		dolibarr_set_const($db, 'DOLICAR_PROJECT_OPPORTUNITY_AMOUNT_VALUE', $projectOpportunityAmount, 'integer', 0, '', $conf->entity);
	}
	if (!empty($client)) {
		dolibarr_set_const($db, 'DOLICAR_THIRDPARTY_CLIENT_VALUE', $client, 'integer', 0, '', $conf->entity);
	}
	if (!empty($taskLabel)) {
		dolibarr_set_const($db, 'DOLICAR_TASK_LABEL_VALUE', $taskLabel, 'chaine', 0, '', $conf->entity);
	}
	if ($timespent >= 0) {
		dolibarr_set_const($db, 'DOLICAR_TASK_TIMESPENT_VALUE', $timespent, 'chaine', 0, '', $conf->entity);
	}
	if (!empty($typeEvent)) {
		dolibarr_set_const($db, 'DOLICAR_EVENT_TYPE_CODE_VALUE', $typeEvent, 'chaine', 0, '', $conf->entity);
	}
	dolibarr_set_const($db, 'DOLICAR_EVENT_STATUS_VALUE', $statusEvent, 'integer', 0, '', $conf->entity);
...
$title    = $langs->trans('DolicarSetup', 'DoliCar');
$help_url = 'FR:Module_DoliCar';
...
print dol_get_fiche_head($head, 'quickcreation', $title, -1, 'dolicar@dolicar');
...
//print ajax_constantonoff('DOLICAR_THIRDPARTY_CLIENT_VISIBLE');
print '</td>';

if ($conf->global->DOLICAR_THIRDPARTY_CLIENT_VISIBLE > 0 && isModEnabled('societe')) {
	print '<td>' . $formcompany->selectProspectCustomerType($conf->global->DOLICAR_THIRDPARTY_CLIENT_VALUE, 'client', 'customerprospect', 'form', 'minwidth200') . '</td>';
} else {
	print '<td></td>';
}
print '</tr>';
...
print '<td class="center">';
//print ajax_constantonoff('DOLICAR_THIRDPARTY_NAME_VISIBLE');
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_THIRDPARTY_PHONE_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_THIRDPARTY_EMAIL_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_THIRDPARTY_WEB_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_THIRDPARTY_PRIVATE_NOTE_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_THIRDPARTY_CATEGORIES_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
//print ajax_constantonoff('DOLICAR_CONTACT_LASTNAME_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_CONTACT_FIRSTNAME_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_CONTACT_JOB_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_CONTACT_PHONEPRO_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_CONTACT_EMAIL_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
//print ajax_constantonoff('DOLICAR_PROJECT_LABEL_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_PROJECT_OPPORTUNITY_STATUS_VISIBLE');
print '</td>';

if ($conf->global->DOLICAR_PROJECT_OPPORTUNITY_STATUS_VISIBLE > 0 && isModEnabled('project')) {
	print '<td>';
	print $formproject->selectOpportunityStatus('project_opportunity_status', $conf->global->DOLICAR_PROJECT_OPPORTUNITY_STATUS_VALUE, 1, 0, 0, 0, 'minwidth200', 0, 1);
	print '</td>';
}
print '</td></tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_PROJECT_OPPORTUNITY_AMOUNT_VISIBLE');
print '</td>';

if ($conf->global->DOLICAR_PROJECT_OPPORTUNITY_AMOUNT_VISIBLE > 0) {
	print '<td><input type="number" name="project_opportunity_amount" class="minwidth200" value="' . $conf->global->DOLICAR_PROJECT_OPPORTUNITY_AMOUNT_VALUE . '"></td>';
} else {
	print '<td></td>';
}
print '</tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_PROJECT_DATE_START_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_PROJECT_CATEGORIES_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
//print ajax_constantonoff('DOLICAR_TASK_LABEL_VISIBLE');
print '</td>';

if ($conf->global->DOLICAR_TASK_LABEL_VISIBLE > 0 && isModEnabled('project')) {
	print '<td><input type="text" id="task_label" name="task_label" value="' . $conf->global->DOLICAR_TASK_LABEL_VALUE . '"></td>';
} else {
	print '<td></td>';
}
print '</tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_TASK_TIMESPENT_VISIBLE');
print '</td>';

if ($conf->global->DOLICAR_TASK_TIMESPENT_VISIBLE > 0) {
	print '<td><input type="number" id="timespent" name="timespent" value="' . $conf->global->DOLICAR_TASK_TIMESPENT_VALUE . '"></td>';
} else {
	print '<td></td>';
}
print '</tr>';
...
print '<td class="center">';
//print ajax_constantonoff('DOLICAR_EVENT_TYPE_CODE_VISIBLE');
print '</td>';

if ($conf->global->DOLICAR_EVENT_TYPE_CODE_VISIBLE > 0) {
	print '<td>';
	print $formactions->select_type_actions($conf->global->DOLICAR_EVENT_TYPE_CODE_VALUE, 'actioncode', 'systemauto', 0, -1, 0, 1);
	print '</td>';
}
print '</td></tr>';
...
print '<td class="center">';
//print ajax_constantonoff('DOLICAR_EVENT_LABEL_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
//print ajax_constantonoff('DOLICAR_EVENT_DATE_START_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_EVENT_DATE_END_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_EVENT_STATUS_VISIBLE');
print '</td>';

if ($conf->global->DOLICAR_EVENT_STATUS_VISIBLE > 0) {
	$listofstatus = [
	...
	print '<td>' . $form->selectarray('status', $listofstatus, (GETPOSTISSET('status') ? GETPOST('status') : $conf->global->DOLICAR_EVENT_STATUS_VALUE), 0, 0, 0, '', 0, 0, 0, '', 'maxwidth200 widthcentpercentminusx') . '</td>';
} else {
	print '<td></td>';
}
print '</tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_EVENT_DESCRIPTION_VISIBLE');
print '</td></td><td></td></tr>';
...
print '<td class="center">';
print ajax_constantonoff('DOLICAR_EVENT_CATEGORIES_VISIBLE');
print '</td></td><td></td></tr>';
