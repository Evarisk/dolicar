...
class RegistrationCertificateFr extends CommonObject
{
	...
	public $fields=array(
		...
		'entity' => array('type'=>'integer', 'label'=>'Entity', 'enabled'=>'1', 'position'=>30, 'notnull'=>1, 'visible'=>0, 'default'=>'1', 'index'=>1,),
		...
		'c3_registration_address' => array('type'=>'textarea', 'label'=>'RegistrationAddress', 'enabled'=>'1', 'position'=>110, 'notnull'=>0, 'visible'=>3,),
		...
		'd3_vehicle_model' => array('type'=>'varchar(128)', 'label'=>'VehicleModel', 'enabled'=>'1', 'position'=>180, 'notnull'=>0, 'visible'=>3,),
		...
		'j3_national_bodywork' => array('type'=>'varchar(128)', 'label'=>'NationalBodyWork', 'enabled'=>'1', 'position'=>300, 'notnull'=>1, 'visible'=>3,),
		...
		'z1_specific_details' => array('type'=>'textarea', 'label'=>'SpecificDetails1', 'enabled'=>'1', 'position'=>500, 'notnull'=>0, 'visible'=>3,),
		'z2_specific_details' => array('type'=>'textarea', 'label'=>'SpecificDetails2', 'enabled'=>'1', 'position'=>510, 'notnull'=>0, 'visible'=>3,),
		'z3_specific_details' => array('type'=>'textarea', 'label'=>'SpecificDetails3', 'enabled'=>'1', 'position'=>520, 'notnull'=>0, 'visible'=>3,),
		'z4_specific_details' => array('type'=>'textarea', 'label'=>'SpecificDetails4', 'enabled'=>'1', 'position'=>530, 'notnull'=>0, 'visible'=>3,),
	...
	public function setDraft($user, $notrigger = 0)
	{
		...
		return $this->setStatusCommon($user, self::STATUS_DRAFT, $notrigger, 'REGISTRATIONCERTIFICATEFR_UNVALIDATE');
	}
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$url = dol_buildpath('/dolicar/registrationcertificatefr_card.php', 1).'?id='.$this->id;
