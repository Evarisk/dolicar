...
class RegistrationCertificateFr extends SaturneObject
{
    ...
    public $fields = [
        ...
        'fk_product'                          => ['type' => 'integer:Product:product/class/product.class.php:1',             'label' => 'Product',      'picto' => 'product', 'enabled' => 1, 'position' => 12,  'notnull' => 0, 'visible' => 1, 'index' => 1, 'css' => 'maxwidth500 widthcentpercentminusxx', 'foreignkey' => 'product.rowid'],
        'fk_lot'                              => ['type' => 'integer:Productlot:product/stock/class/productlot.class.php:1', 'label' => 'DolicarBatch', 'picto' => 'lot',     'enabled' => 1, 'position' => 13,  'notnull' => 0, 'visible' => 5, 'index' => 1, 'css' => 'maxwidth500 widthcentpercentminusxx', 'foreignkey' => 'productlot.rowid'],
