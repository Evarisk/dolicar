...
$langs->loadLangs(array("dolicar@dolicar"));
...
llxHeader("", $langs->trans("DoliCarArea"));
...
// Draft MyObject
if (! empty($conf->dolicar->enabled) && $user->rights->dolicar->read)
{
	$langs->load("orders");
...
if (! empty($conf->dolicar->enabled) && $user->rights->dolicar->read)
{
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."dolicar_myobject as s";
	//if (! $user->rights->societe->client->voir && ! $socid) $sql.= ", ".MAIN_DB_PREFIX."societe_commerciaux as sc";
