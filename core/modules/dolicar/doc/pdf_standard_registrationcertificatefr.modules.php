...
/**
 *  \file       core/modules/dolicar/doc/pdf_standard.modules.php
 *  \ingroup    dolicar
 ...
 */
class pdf_standard_registrationcertificatefr extends ModelePDFRegistrationCertificateFr
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_REGISTRATIONCERTIFICATEFR_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->dolicar->dir_output.'/registrationcertificatefr') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->dolicar->dir_output.'/registrationcertificatefr';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->dolicar->dir_output.'/registrationcertificatefr/'.$objectref;
			...
			if (file_exists($dir)) {
				...
				if ($cert) {
					$info = array(
						...
						'Reason' => 'REGISTRATIONCERTIFICATEFR',
