...
/**
 * \file    test/phpunit/DoliCarFunctionalTest.php
 * \ingroup dolicar
 ...
 * @package Testdolicar
 */
class DoliCarFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/dolicar/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolicar/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolicar/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolicar/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolicarwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoliCar_DoliCarTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoliCar_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
